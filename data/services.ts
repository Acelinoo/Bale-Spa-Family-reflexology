...
export const SERVICES: ServiceItem[] = [
  {
    ...
    category: "massage",
    badge: "Most Popular",
    shortDesc: "Relaxing essential oil massage to relieve stress and tension.",
    description:
  ...
  },
  {
    ...
    category: "treatment",
    badge: "Deep Warmth",
    shortDesc: "Heated stones to ease muscle stiffness and improve circulation.",
    description:
  ...
  },
  {
    ...
    category: "treatment",
    badge: "Glow & Fresh",
    shortDesc: "Rejuvenate your skin with our personalized facial therapies.",
    description:
  ...
  },
  {
    ...
    shortDesc: "Stimulate pressure points to restore balance and promote healing.",
    description:
  ...
  },
  {
    ...
    category: "massage",
    badge: "Total Renewal",
    shortDesc: "Detoxifying wraps to nourish your skin and refresh your body.",
    description:
  ...
  },
  {
    ...
    category: "package",
    badge: "Best Value",
    shortDesc: "Specially curated packages for complete relaxation and wellness.",
    description:
